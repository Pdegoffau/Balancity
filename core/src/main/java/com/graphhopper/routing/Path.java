...
public class Path implements TimeConversion
{
    ...
    /**
     * Update a particular edge at time 'endTime'. 
     * @param edge the edgeEntry generated by the algorithm
    ...
    /**
     * This method handles the update procedure of the traffic density
     * @param edge The final edge
     * @param totalTime The time at which that edge is reached
     */

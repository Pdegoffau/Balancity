 ...
 * TODO: change speeds and such, now it is the same as for carFlagEncoder
 */
public class TruckFlagEncoder extends AbstractFlagEncoder implements EnvironmentImpact
{
